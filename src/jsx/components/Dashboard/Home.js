...
const ChartBarApex = loadable(() => pMinDelay(import("./Dashboard/ChartBarApex"), 1000));
const ReservationChart = loadable(() => pMinDelay(import("./Dashboard/ReservationChart"), 1000));
const RedialApex = loadable(() => pMinDelay(import("./Dashboard/RedialApex"), 1000));
const NewCustomers = loadable(() => pMinDelay(import("./Dashboard/NewCustomers"), 1000));
const NewProject = loadable(() => pMinDelay(import("./Dashboard/NewProject"), 1000));
const Emailchart = loadable(() => pMinDelay(import("./Dashboard/Emailchart"), 1000));
                  ...
                  <div className="card" id="user-activity">
                    <div className="card-header border-0 pb-0 flex-wrap">
                      <div>
                        ...
                        <span>
                          <small className="text-success">+2.7%</small> than last week
                        </span>
                      </div>
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div className="mt-4 text-center">
                        <h4 className="fs-20 font-w700">Total Task in Progress</h4>
                        <p className="mb-0">The total number of task in-progress</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-xl-12">
              <div className="card">
                <div className="card-header border-0 pb-0">
                  <h4 className="fs-20 font-w700 mb-0">Project Statistics</h4>
                  <Dropdownblog />
                </div>
                ...
                <div className="card-body d-flex px-4 pb-0 justify-content-between">
                  ...
                  <div className="bg-gradient1 rounded text-center p-3">
                    <div className="d-inline-block position-relative donut-chart-sale mb-3">
                      <DonutChart value="70" backgroundColor="#00a15d" backgroundColor2="rgba(238, 238, 237, 1)" />
                ...
                <div className="card-body d-flex px-4  justify-content-between">
                  <div>
                    <div className="">
                      ...
                      <span className="d-block fs-16 font-w400">
                        <small className="text-success">-2%</small> than last month
                      </span>
                    </div>
                  </div>
              ...
              <div className="card">
                <div className="card-header border-0">
                  <div>
                    ...
                    <span className="fs-14 font-w400 d-block">list of project Categories</span>
                  </div>
                  <Dropdownblog />
                </div>
                <div className="card-body pt-0">
                  <div className="row align-items-center">
                    ...
                    <div className="col-xl-6 text-center">
                      ...
                      <Link to={"#"} className="btn btn-outline-primary btn-rounded mb-sm-0 mb-2">
                        Update Progress
                      </Link>
                    </div>
                  </div>
              ...
              <div className="card">
                <div className="card-header border-0 flex-wrap pb-2">
                  <div className="mb-2">
                    ...
                    <span>List of recent messages</span>
                  </div>
                  <div className="mb-2">
