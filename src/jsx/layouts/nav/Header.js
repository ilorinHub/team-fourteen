            ...
            <ul className="navbar-nav header-right">
              ...
              >
                ...
                >
					...
					<span className="badge light text-white bg-blue rounded-circle">16</span>
                </Dropdown.Toggle>
				...
				<Dropdown
				  ...
				  >
					...
					>
						...
						<span className="badge light text-white bg-secondary rounded-circle">27</span>
					</Dropdown.Toggle>
				</Dropdown>	
              ...
              >
                ...
                >
					...
					<span className="badge light text-white bg-primary rounded-circle">23</span>
                </Dropdown.Toggle>
