...
import Projects from "./pages/WakandaProject/Projects";

export const RedirectComp = () => {
...
const Markup = () => {
  ...
  const routes = [
    // Wakanda project routes
    { url: "", component: RedirectComp },
    { url: "dashboard", component: Home },
    { url: "projects", component: Projects },
    { url: "tasks", component: Kanban },
    { url: "message", component: Messages },
    { url: "reports", component: Error503 },

    { url: "template-dashboard", component: Home },
